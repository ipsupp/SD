...
void ATM::tranzactie(int suma)
{
    ...
    while (index_cea_mai_mare_bancnota < 8 and suma != 0)
    {
        int nr_banc = 0, ok = 0;
        if (suma_curenta >= bancnote[index_cea_mai_mare_bancnota] and bancnote_din_atm[index_cea_mai_mare_bancnota] != 0)
        {
    ...
    else if (suma == 0 and index_cea_mai_mare_bancnota < 8)
    {
...
//    if (tranz.procesare() == true)
//    {
//        int v[8] = {0};
//        int bancnote[] = {500, 200, 100, 50, 20, 10, 5, 1};
//        if( tranz.procesare() == true)
//        {
//            tranz.copie_bancnote_retrase(v);
//            cout << "ATM-ul foloseste urmatoarele bancnote pentru tranzactie:" << endl;
//            for (int i = 0; i < 8; i++)
//                cout << bancnote[i] << " * " << v[i] << " ; ";
//            cout << "Confirmati?" << " Y/N" << endl;
//            char a;
